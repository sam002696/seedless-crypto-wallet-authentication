      ...
      {selectedTransaction && (
        <TransactionDetailsModal
          ...
          transactionDetails={{
            ...
            nonce: selectedTransaction.nonce || "N/A",
            amount: selectedTransaction.value,
            gasUsed: selectedTransaction.gasUsed || "N/A",
            baseFee: selectedTransaction.baseFee || "N/A",
            priorityFee: selectedTransaction.priorityFee || "N/A",
            totalFee: selectedTransaction.totalFee || "N/A",
